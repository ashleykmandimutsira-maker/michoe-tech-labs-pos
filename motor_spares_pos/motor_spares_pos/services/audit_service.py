...
class AuditService:
    ...
    def log_authorization(
        ...
        approving_user_id: Optional[int],
        action: str,
        entity_id: int,
        entity_type: Optional[str] = None,
        reason: Optional[str] = None,
    ...
    def log_return_creation(
        self, return_id: int, user_id: int, reason: str
    ) -> int:
        """Log return creation."""
    ...
    def log_return_approval(
        self, return_id: int, user_id: int, approved_by: int
    ) -> int:
        """Log return approval."""
    ...
    def log_product_archive(
        ...
        self.db.execute_update(
            query, (product_id, requesting_user_id, approving_admin_id, reason)
        )
        return self.db.get_last_insert_id()

    def log_product_restore(
        self,
        product_id: int,
        requesting_user_id: int,
        approving_admin_id: int,
    ...
    def log_user_creation(
        self, new_user_id: int, created_by_user_id: int
    ) -> int:
        """Log user creation."""
        return self.log_action(
            action="USER_CREATED",
    ...
    def log_system_setting_change(
        self, user_id: int, setting_name: str, old_value: str, new_value: str
    ) -> int:
        """Log system setting change."""
        details = (
            f"Setting: {setting_name}, Old: {old_value}, New: {new_value}"
        )
        return self.log_action(
