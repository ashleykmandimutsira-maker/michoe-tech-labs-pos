...
def initialize_sample_data():
    ...
    existing_categories = {
        cat.name: cat for cat in product_service.get_all_categories()
    }
    ...
    for cat_name, cat_desc in categories.items():
        ...
        try:
            ...
            existing_categories[cat_name] = product_service.get_category_by_id(
                cat_id
            )
    ...
    for prod_data in sample_products:
        ...
        try:
            ...
            created_products += 1
            logger.info(
                "Created sample product: %s (ID: %s)", part_no, product_id
            )
        except Exception:
